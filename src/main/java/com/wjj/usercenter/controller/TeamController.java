...
import com.wjj.usercenter.common.DeleteRequest;
...
public class TeamController {
    ...
    public BaseResponse<List<TeamUserVO>> listTeams(TeamQuery teamQuery, HttpServletRequest request) {
        ...
        teamList = addOthers(teamList, request);
    ...
    public List<TeamUserVO>  addOthers(List<TeamUserVO> teamList, HttpServletRequest request){
        // 1.查询队伍列表
        ...
        teamList.forEach(team -> {
            ...
            team.setJoinTeamUsersId(userIdList);
            team.setJoinTeamUsers(userService.listByIds(userIdList));
        });
        return teamList;
    }
